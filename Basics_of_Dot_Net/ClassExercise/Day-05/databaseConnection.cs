...
namespace TestDBMSConnectionApp
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var datasource = @"LAPTOP-LF8PDD3Q"; // your server
        ...
        static void InsertStaff(SqlConnection conn)
        {
            ...
            int foodId = 2;
            string name = "Rajma";
            string querry = "insert into tb_food (food_id,name) values(" + foodId + ",'"+name+"')";
        ...
        static void displayStaff(SqlConnection conn)
        {
            ...
            Console.WriteLine("food all data :");
            while (reader.Read())
            {
                {
                    Console.WriteLine($"food id :{reader["food_id"]}");
